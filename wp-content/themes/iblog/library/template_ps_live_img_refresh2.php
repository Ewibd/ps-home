	...
	<div class="postwrap fix">
		<div <?php post_class() ?> id="post-<?php the_ID(); ?>">
			<?php if (have_posts()) :
 											...
 											function refreshIt() {                                                                           
   											if (!document.images) return;                                                                  
   												...
   												<?php if $auto_refresh_oui_non =="OUI" {
		   												?>
		   												 setTimeout('refreshIt()',<?php echo($intervalle_refresh_millisec); ?>)
		   												<?php
		   													}
		   												?>                                   
										}
										; // refresh intervall (millisecs)                                                                                                   
										//--></script>                                                                                     
						      	                                                                                                   
						      	<?php                                                                                              
						      	//on commence a afficher des trucs
						      	...
						      	if $auto_refresh_oui_non =="OUI" {
						      		echo("onLoad=\setTimeout('refreshIt()'," + $intervalle_refresh_millisec + ")\"");
						      		}
